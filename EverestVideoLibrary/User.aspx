<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="EverestVideoLibrary.User" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBoxDesignation" runat="server" placeholder="Designation"></asp:TextBox>
                        </div>
